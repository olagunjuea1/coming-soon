function Herofoot() {
  return (
    <section
      className="relative w-11/12 mx-auto py-8 z-50 bg-transparent"
      id="HeroSection"
    >
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 md:gap-y-0 gap-x-4 items-center">
          <div className="relative flex flex-row gap-x-3 z-50 bg-transparent" aria-labelledby="Social Follow">
            <a href="/">
              <div className="bg-transparent w-10 h-10 flex items-center justify-center rounded-full border border-black">
                <svg
          ...
          <div className="relative flex justify-start md:justify-end z-50 bg-transparent" aria-labelledby="Links">
            <ul className="flex flex-row space-x-8 text-sm foot_links px-1">
              <a href="/">
                <li>FAQ</li>
              </a>
              <a href="/">
